Ext.define("PM.view.perScore.perScoreManageView", {
	extend : 'Ext.panel.Panel',
	alias : 'widget.perScoreManageView', // 这里一定要设置别名
	border : 0,
	layout : 'anchor',
	anchor : '100% 100%',
	initComponent : function() {
		Ext.apply(this, {
			items : [{
				xtype : 'grid',
				itemId : 'perScoreManageViewGrid',
				columnLines : true,
				store : 'perScore.perScoreLists',
				viewConfig:{
				...
				tbar : [ {
					...
					store : new Ext.data.SimpleStore({  
						fields : [ 'name', 'value' ],
						data : [ [ '客户名', 'userName' ], [ '客户号码', 'cellphone' ], [ '身份证号', 'idcard' ],
						         [ '姓名', '姓名' ]] 
                    }),
