...
public class ZXingUtil { 
	...
	public static void main(String[] args) {
		/**** 二维码 */
		encodeQRCodeImage("http://www.163.com", null, "D:/12345.png", 300, 300,null);
		System.out.println(decodeQRCodeImage("D:/12345.png", null));
        ...
        System.out.println(encode(contents, width, height, imgPath));
	}
}