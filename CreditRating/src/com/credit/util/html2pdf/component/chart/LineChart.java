package com.credit.util.html2pdf.component.chart;
...
import com.credit.util.html2pdf.component.Constant;
...
public abstract class LineChart {
    ...
    private  String   drawLineChar(String title, String xLabel, String yLabel, DefaultCategoryDataset dataSet, int picId)
        ...
        String filePath=Constant.Image_PATH+picId+"/"+getFileName();
    ...
    public static Font getFont(int style,float fontSize){
        try {
            String fontPath = Constant.Font_PATH+"SIMLI.TTF";
