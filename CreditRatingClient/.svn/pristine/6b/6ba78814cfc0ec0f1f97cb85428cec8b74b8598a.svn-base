...
/**
 * <p>selectTrademarkListResponse complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="selectTrademarkListResponse">
 *   &lt;complexContent>
...
@XmlType(name = "selectTrademarkListResponse", propOrder = {
    "_return"
})
public class SelectTrademarkListResponse {
