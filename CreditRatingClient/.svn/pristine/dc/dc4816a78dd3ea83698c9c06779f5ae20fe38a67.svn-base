...
function (a, b) {
    ...
    function u(a, b, c, d) {
        for (var e = c === (d ? "border" : "content") ? 4 : "width" === b ? 1 : 0, f = 0; 4 > e; e += 2)"margin" === c && (f += $.css(a, c + pc[e], !0)),
        d ? ("content" === c && (f -= parseFloat(cc(a, "padding" + pc[e])) || 0), "margin" !== c && (f -= parseFloat(cc(a, "border" + pc[e] + "Width")) || 0)) : (f += parseFloat(cc(a, "padding" + pc[e])) || 0, "padding" !== c && (f += parseFloat(cc(a, "border" + pc[e] + "Width")) || 0));
        return f
    }
    function v(a, b, c) {
    ...
    function z(a, c, d, e, f, g) {
        ...
        g = g || {},
        g[f] = !0;
        for (var h, i = a[f], j = 0, k = i ? i.length : 0, l = a === Jc; k > j && (l || !h); j++) h = i[j](c, d, e),
    ...
    var N, O, P = a.document,
        ...
        ab = /\S/,
        bb = /\s+/,
        cb = ab.test(" ") ? /^[\s\xA0]+|[\s\xA0]+$/g : /^\s+|\s+$/g,
        db = /^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/,
        eb = /^<(\w+)\s*\/?>(?:<\/\1>|)$/,
        fb = /^[\],:{}\s]*$/,
        gb = /(?:^|:|,)(?:\s*\[)+/g,
    ...
    $.extend = $.fn.extend = function () {
            var a, c, d, e, f, g, h = arguments[0] || {},
                ...
                j = arguments.length,
                k = !1;
            for ("boolean" == typeof h && (k = h, h = arguments[1] || {}, i = 2), "object" != typeof h && !$.isFunction(h) && (h = {}), j === i && (h = this, --i); j > i; i++) if (null != (a = arguments[i])) for (c in a) d = h[c],
            e = a[c],
    ...
    $.ready.promise = function (b) {
            if (!O) if (O = $.Deferred(), "complete" === P.readyState || "loading" !== P.readyState && P.addEventListener) setTimeout($.ready, 1);
                ...
                m = {
                    ...
                    remove: function () {
                        return j && $.each(arguments, function (a, b) {
                            for (var c;
                            (c = $.inArray(b, j, c)) > -1;) j.splice(c, 1),
                            f && (h >= c && h--, i >= c && i--)
                        }),
                        this
                    },
            ...
            data: function (a, c, d, e) {
                if ($.acceptData(a)) {
                    var f, g, h = $.expando,
                        ...
                        k = j ? $.cache : a,
                        l = j ? a[h] : a[h] && h;
                    if (l && k[l] && (e || k[l].data) || !i || d !== b) return l || (j ? a[h] = l = $.deletedIds.pop() || ++$.uuid : l = h),
            ...
            data: function (a, c) {
                ...
                if (a === b) {
                        if (this.length && (l = $.data(j), 1 === j.nodeType && !$._data(j, "parsedAttrs"))) {
                            ...
                            0 === h.indexOf("data-") && (h = $.camelCase(h.substring(5)), d(j, h, l[h]));
            ...
            toggleClass: function (a, b) {
                ...
                return this.each($.isFunction(a) ?
                    function (c) {
                        ...
                        if ("string" === c) for (var e, f = 0, g = $(this), h = b, i = a.split(bb); e = i[f++];) h = d ? h : !g.hasClass(e),
            ...
            remove: function (a, b, c, d, e) {
                ...
                if (q && (m = q.events)) {
                    for (b = $.trim(Hb(b || "")).split(" "), f = 0; f < b.length; f++) if (g = Cb.exec(b[f]) || [], h = i = g[1], j = g[2], h) {
                        for (n = $.event.special[h] || {}, h = (d ? n.delegateType : n.bindType) || h, o = m[h] || [], k = o.length, j = j ? new RegExp("(^|\\.)" + j.split(".").sort().join("\\.(?:.*\\.|)") + "(\\.|$)") : null, l = 0; l < o.length; l++) p = o[l],
            ...
            dispatch: function (c) {
                ...
                if (p[0] = c, c.delegateTarget = this, !r.preDispatch || r.preDispatch.call(this, c) !== !1) {
                        ...
                        for (n.length > o && s.push({
                            elem: this,
                            matches: n.slice(o)
                        }), d = 0; d < s.length && !c.isPropagationStopped(); d++) for (j = s[d], c.currentTarget = j.elem, e = 0; e < j.matches.length && !c.isImmediatePropagationStopped(); e++) l = j.matches[e],
                        (q || !c.namespace && !l.namespace || c.namespace_re && c.namespace_re.test(l.namespace)) && (c.data = l.data, c.handleObj = l, h = (($.event.special[l.origType] || {}).handle || l.handler).apply(j.elem, p), h !== b && (c.result = h, h === !1 && (c.preventDefault(), c.stopPropagation())));
    ...
    function (a, b) {
            ...
            function e(a, e, f, g, h) {
                for (var i, j, k, l, m, n, o, p, q = 0, r = h.length, s = S.POS, t = new RegExp("^" + s.source + "(?!" + y + ")", "i"), u = function () {
                    ...
                    for (s.exec(""), a = h[q], l = [], k = 0, m = g; i = s.exec(a);) p = s.lastIndex = i.index + i[0].length,
                    p > k && (o = a.slice(k, i.index), k = p, n = [e], I.test(o) && (m && (n = m), m = g), (j = O.test(o)) && (o = o.slice(0, -5).replace(I, "$&*")), i.length > 1 && i[0].replace(t, u), m = d(o, i[1], i[2], n, m, j));
            ...
            function f(a, b, c) {
                for (var d, e, f, g = [], h = 0, i = K.exec(a), j = !i.pop() && !i.pop(), k = j && a.match(J) || [""], l = gb.preFilter, m = gb.filter, n = !c && b !== p; null != (e = k[h]) && j; h++) for (g.push(d = []), n && (e = " " + e); e;) {
                    j = !1,
                    (i = I.exec(e)) && (e = e.slice(i[0].length), j = d.push({
                ...
                function (b, c) {
                        ...
                        for (var f, g = e + "." + l, h = g + "." + k; b = b[d];) if (1 === b.nodeType) {
                            ...
                            if ("string" == typeof f && 0 === f.indexOf(g)) {
                                ...
                                if (b[x] = h, a(b, c)) return b.sizset = !0,
                                b;
                                b.sizset = !1
                            }
                        }
            ...
            var k, l, m, n, o, p = a.document,
                ...
                eb = _(function (a) {
                    ...
                    a.getElementsByClassName && 0 !== a.getElementsByClassName("e").length ? (a.lastChild.className = "e", 1 !== a.getElementsByClassName("e").length) : !1
                }),
                fb = function (a, b, c, d) {
                    c = c || [],
                    b = b || p;
                    ...
                    if (g = ib(b), !g && !d && (e = M.exec(a))) if (h = e[1]) {
                        if (9 === i) {
                            ...
                            c
                        } else if (b.ownerDocument && (f = b.ownerDocument.getElementById(h)) && jb(b, f) && f.id === h) return c.push(f),
                        c
                    } else {
                        if (e[2]) return w.apply(c, v.call(b.getElementsByTagName(a), 0)),
                        c;
                        if ((h = e[3]) && eb && b.getElementsByClassName) return w.apply(c, v.call(b.getElementsByClassName(h), 0)),
                        c
                    }
                    return mb(a, b, c, d, g)
                },
                gb = fb.selectors = {
                    ...
                    preFilter: {
                        ...
                        CHILD: function (a) {
                            ...
                            "nth" === a[1] ? (a[2] || fb.error(a[0]), a[3] = +(a[3] ? a[4] + (a[5] || 1) : 2 * ("even" === a[2] || "odd" === a[2])), a[4] = +(a[6] + a[7] || "odd" === a[2])) : a[2] && fb.error(a[0]),
                            a
                        },
                        PSEUDO: function (a) {
                            var b, c = a[4];
                    ...
                    filter: {
                        ...
                        CLASS: function (a) {
                            var b = T[a];
                            return b || (b = T[a] = new RegExp("(^|" + y + ")" + a + "(" + y + "|$)"), U.push(a), U.length > gb.cacheLength && delete T[U.shift()]),
                        ...
                        PSEUDO: function (a, b, c, d) {
                            ...
                            return e || fb.error("unsupported pseudo: " + a),
            ...
            gb.setFilters.nth = gb.setFilters.eq,
            gb.filters = gb.pseudos,
            db || (gb.attrHandle = {
                    href: function (a) {
            ...
            var ib = fb.isXML = function (a) {
                ...
                jb = fb.contains = q.compareDocumentPosition ?
            function (a, b) {
            ...
            fb.attr = function (a, b) {
                    ...
                    gb.attrHandle[b] ? gb.attrHandle[b](a) : ab || d ? a.getAttribute(b) : (c = a.getAttributeNode(b), c ? "boolean" == typeof a[b] ? a[b] ? b : null : c.specified ? c.value : null : null)
                },
            fb.error = function (a) {
            ...
            var lb = fb.compile = function (a, b, c) {
                    ...
                    h.runs = h.dirruns = 0,
                    W.push(a),
                    W.length > gb.cacheLength && delete V[W.shift()],
                    h
                };
            ...
            var mb = function (a, b, c, d, f) {
                    ...
                    if (a) for (h = lb(a, b, f), l = h.dirruns++, null == g && (g = gb.find.TAG("*", N.test(a) && b.parentNode || b)), i = 0; m = g[i]; i++) k = h.runs++,
                    h(m, b) && c.push(m);
                    return c
                };
            p.querySelectorAll &&
            ...
            $.expr = fb.selectors,
            $.expr[":"] = $.expr.pseudos,
            $.unique = fb.uniqueSort,
            $.text = fb.getText,
            $.isXMLDoc = fb.isXML,
            $.contains = fb.contains
        }(a);
    var Ib = /Until$/,
    ...
    a.getComputedStyle ? cc = function (a, b) {
            var c, d, e, f, g = getComputedStyle(a, null),
                h = a.style;
            return g && (c = g[b], "" === c && !$.contains(a.ownerDocument.documentElement, a) && (c = $.style(a, b)), kc.test(c) && ic.test(b) && (d = h.width, e = h.minWidth, f = h.maxWidth, h.minWidth = h.maxWidth = h.width = c, c = g.width, h.width = d, h.minWidth = e, h.maxWidth = f)),
            c
        } : P.documentElement.currentStyle && (cc = function (a, b) {
            var c, d, e = a.currentStyle && a.currentStyle[b],
                f = a.style;
            return null == e && f && f[b] && (e = f[b]),
            kc.test(e) && !hc.test(b) && (c = f.left, d = a.runtimeStyle && a.runtimeStyle.left, d && (a.runtimeStyle.left = a.currentStyle.left), f.left = "fontSize" === b ? "1em" : e, e = f.pixelLeft + "px", f.left = c, d && (a.runtimeStyle.left = d)),
            "" === e ? "auto" : e
        }),
    ...
    var xc, yc, zc = /#.*$/,
        Ac = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm,
        Bc = /^(?:about|app|app\-storage|.+\-extension|file|res|widget):$/,
        Cc = /^(?:GET|HEAD)$/,
        Dc = /^\/\//,
        Ec = /\?/,
    ...
    try {
            ...
            xc = P.createElement("a"),
            xc.href = "",
            xc = xc.href
        }
    yc = Hc.exec(xc.toLowerCase()) || [],
    $.fn.load = function (a, c, d) {
            ...
            $.ajax({
                    ...
                    g = arguments,
                    h.html(e ? $("<div>").append(a.replace(Fc, "")).find(e) : a)
                }),
            this
        },
    ...
    $.extend({
            ...
            ajax: function (a, c) {
                ...
                w.setRequestHeader("Accept", m.dataTypes[0] && m.accepts[m.dataTypes[0]] ? m.accepts[m.dataTypes[0]] + ("*" !== m.dataTypes[0] ? ", " + Lc + "; q=0.01" : "") : m.accepts["*"]);
    ...
    $.ajaxPrefilter("json jsonp", function (c, d, e) {
            var f, g, h, i = c.data,
                ...
                k = c.jsonp !== !1,
                l = k && Pc.test(j),
                m = k && !l && "string" == typeof i && !(c.contentType || "").indexOf("application/x-www-form-urlencoded") && Pc.test(i);
            return "jsonp" === c.dataTypes[0] || l || m ? (f = c.jsonpCallback = $.isFunction(c.jsonpCallback) ? c.jsonpCallback() : c.jsonpCallback, g = a[f], l ? c.url = j.replace(Pc, "$1" + f) : m ? c.data = i.replace(Pc, "$1" + f) : k && (c.url += (Oc.test(j) ? "&" : "?") + c.jsonp + "=" + f), c.converters["script json"] = function () {
                    ...
                    a[f] = g,
                    c[f] && (c.jsonpCallback = d.jsonpCallback, Nc.push(f)),
                ...
                return {
                    send: function (e, f) {
                        ...
                        d = function (a, e) {
                            var h, j, k, l, m;
                            try {
                                if (d && (e || 4 === i.readyState)) if (d = b, g && (i.onreadystatechange = $.noop, Sc && delete Rc[g]), e) 4 !== i.readyState && i.abort();
                                else {
                                    h = i.status,
    ...
    var Uc, Vc, Wc = /^(?:toggle|show|hide)$/,
        Xc = new RegExp("^(?:([-+])=|)(" + _ + ")([a-z%]*)$", "i"),
        Yc = /queueHooks$/,
        Zc = [J],
        $c = {
            "*": [function (a, b) {
    ...
    $.fn.extend({
            ...
            stop: function (a, c, d) {
                ...
                this.each(function () {
                    ...
                    else for (c in g) g[c] && g[c].stop && Yc.test(c) && e(g[c]);
    ...
    $.fx = K.prototype.init,
    $.fx.tick = function () {
            for (var a, b = $.timers, c = 0; c < b.length; c++) a = b[c],
