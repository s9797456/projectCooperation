...
/**
 * <p>selectJudicialSaleListBriefResponse complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="selectJudicialSaleListBriefResponse">
 *   &lt;complexContent>
...
@XmlType(name = "selectJudicialSaleListBriefResponse", propOrder = {
    "_return"
})
public class SelectJudicialSaleListBriefResponse {
