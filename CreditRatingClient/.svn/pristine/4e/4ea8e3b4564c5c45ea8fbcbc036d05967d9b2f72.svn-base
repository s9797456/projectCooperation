...
/**
 * <p>selectPartnerWithoutCapiListResponse complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="selectPartnerWithoutCapiListResponse">
 *   &lt;complexContent>
...
@XmlType(name = "selectPartnerWithoutCapiListResponse", propOrder = {
    "_return"
})
public class SelectPartnerWithoutCapiListResponse {
