<%@ page language="java" pageEncoding="UTF-8"%>
				 <nav>
				    <ul class="ucenterNav" id="list">
				        <li class="navIndex">
				                <a href="<%=path %>/customer/jumpToPerMain.do"><i class="iconfont"></i>我的主页</a>
				        </li>
				        <li >
				        ...
				        <li >
				                <a href="<%=path%>/initPersonal/authenticationUI.do"><i class="iconfont"></i>个人认证</a>
				        </li>
				        <li >
				                <a href="<%=path%>/personalInfo/inputPerInfo.do"><i class="iconfont"></i>录入信息</a>
				        </li>
				        <li >
				                <a onclick="rejectedItem()" ><i class="iconfont"></i>被驳回项 </a>
				        </li>
				        <li >
				         		<a href="<%=path%>/initPersonal/viewPreliminary.do"><i class="iconfont"></i>查看评分</a>
				        </li>
				        <li >
