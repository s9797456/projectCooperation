				...
				<div id = "rightUp" style="margin-top: 30px;">
					...
					<div >
						...
						<div id ="userInfo" >
										...
										<c:if test="${! empty processState }">
											<c:choose>
												...
												<c:when test="${processState.applyreportstate == 1 && processState.scorestate == 3}">
													<a style="color:#00C1E1" href="<%=path%>/main/viewPreliminary.do">请查看初评</a>
												</c:when>
									...
									<c:if test="${! empty processState }">
											<c:choose>
												<c:when test="${processState.applyreportstate == 1 && processState.scorestate >= 2}">
													<a style="color:#00C1E1" href="<%=path%>/main/viewPreliminary.do"><div style="margin-bottom: 0px;" class="la1">等级 ：${entResult.preliminarylevel } 级</div>
							...
							<div id = 'scoreInfo1' style="float: right;width: 40vw;min-width:300px;height: 100%;" >
								...
								<div style="width: 50%;height: 49%;float: left;">
									<c:if test="${! empty processState }">
											<c:choose>
												<c:when test="${processState.applyreportstate == 1 && processState.scorestate >= 2}">
													<a style="color:#00C1E1" href="<%=path%>/main/viewPreliminary.do"><div class = "la1" style="margin:0px;margin:auto;line-height: 350%;text-align: center;" ><span>初评等级：${entResult.preliminarylevel }</span><p style="color: rgb(6, 139, 159); font-size: 90%;margin-top: -30px">${entResult.preliminaryscore } 分</p></div>
													</a>
												</c:when>
												<c:otherwise>
